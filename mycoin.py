...
def mine_block():
    ...
    blockchain.add_transaction(sender=node_address, receiver='Mayank', amount=10)
...
def connect_node():
    ...
    response = {'message': 'All the nodes are now connected. The mycoin blockchain contains the following nodes.',
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message': 'The nodes has different chains so the chain is replaced by the longest one.',
